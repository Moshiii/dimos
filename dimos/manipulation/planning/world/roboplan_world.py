...
class RoboPlanWorld:
    ...
    def _validated_selection_start(
        ...
        start: JointState,
        *,
        require_scene_match: bool = True,
    ) -> JointState:
        """Normalize a start and optionally require the authoritative scene state."""
        if not self._is_ready():
            raise ValueError(
        ...
        if require_scene_match and any(
