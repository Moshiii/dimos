...
def test_can_activate_confirms_before_spawning(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_can_activate_rejection_does_not_spawn(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_can_activate_uses_default_bitrate(monkeypatch: pytest.MonkeyPatch) -> None:
