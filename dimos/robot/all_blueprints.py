...
all_blueprints = {
    ...
    "picknplace-perception": "dimos.manipulation.blueprints:picknplace_perception",
    "picknplace-perception-graspgenx": "dimos.manipulation.blueprints:picknplace_perception_graspgenx",
