...
all_blueprints = {
    ...
    "coordinator-flowbase-autotune": "dimos.control.blueprints.mobile:coordinator_flowbase_autotune",
    ...
    "unitree-go2-autotune": "dimos.robot.unitree.go2.blueprints.basic.unitree_go2_autotune:unitree_go2_autotune",
...
all_modules = {
    ...
    "autotune-driver": "dimos.control.autotune.autotune_driver.AutotuneDriver",
