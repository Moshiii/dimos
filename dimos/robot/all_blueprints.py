...
all_blueprints = {
    ...
    "coordinator-gripper-mock": "dimos.robot.grippers.blueprints.basic:coordinator_gripper_mock",
    ...
    "keyboard-teleop-gripper-xarm": "dimos.robot.grippers.blueprints.teleop:keyboard_teleop_gripper_xarm",
