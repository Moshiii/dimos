...
all_blueprints = {
    ...
    "robot-model-validation-a1z": "dimos.robot.model_validation:robot_model_validation_a1z",
    "robot-model-validation-a750": "dimos.robot.model_validation:robot_model_validation_a750",
    "robot-model-validation-g1": "dimos.robot.model_validation:robot_model_validation_g1",
    "robot-model-validation-piper": "dimos.robot.model_validation:robot_model_validation_piper",
    "robot-model-validation-xarm": "dimos.robot.model_validation:robot_model_validation_xarm",
