...
all_blueprints = {
    ...
    "mid360-realsense-fastlivo": "dimos.hardware.sensors.lidar.fastlivo.fastlivo_blueprints:mid360_realsense_fastlivo",
...
all_modules = {
    ...
    "fast-livo": "dimos.hardware.sensors.lidar.fastlivo.module.FastLivo",
