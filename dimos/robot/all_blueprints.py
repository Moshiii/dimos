...
all_blueprints = {
    ...
    "alfred-rtabmap": "dimos.robot.diy.alfred.blueprints.alfred_rtabmap:alfred_rtabmap",
    "alfred-rtabmap-stereo": "dimos.robot.diy.alfred.blueprints.alfred_rtabmap:alfred_rtabmap_stereo",
