...
all_blueprints = {
    ...
    "xarm6-prompted-pick": "dimos.robot.manipulators.xarm.blueprints.prompted_pick:xarm6_prompted_pick",
...
all_modules = {
    ...
    "prompted-object-localizer-module": "dimos.perception.memory.prompted_object_localizer.PromptedObjectLocalizerModule",
    "prompted-pick-and-place-module": "dimos.manipulation.pick_and_place_module.PromptedPickAndPlaceModule",
