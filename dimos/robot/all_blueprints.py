...
all_blueprints = {
    ...
    "drone-city-replay": "dimos.robot.drone.blueprints.basic.drone_city_replay:drone_city_replay",
    ...
    "go2-zenoh-city": "dimos.robot.unitree.go2.zenoh.blueprints:go2_zenoh_city",
    ...
    "go2-zenoh-record": "dimos.robot.unitree.go2.zenoh.blueprints:go2_zenoh_record",
...
all_modules = {
    ...
    "city-mesh-module": "dimos.visualization.citymesh.module.CityMeshModule",
    ...
    "enu-snap-tf": "dimos.visualization.citymesh.enu_tf.EnuSnapTF",
    ...
    "go2-zenoh-recorder": "dimos.robot.unitree.go2.zenoh.recorder.GO2ZenohRecorder",
    "go2-zenoh-replay": "dimos.robot.unitree.go2.zenoh.replay.GO2ZenohReplay",
    ...
    "h264-decoder-module": "dimos.perception.video.h264_decoder_module.H264DecoderModule",
    ...
    "odometry-tracer": "dimos.robot.unitree.go2.zenoh.blueprints.OdometryTracer",
    ...
    "tracer": "dimos.navigation.tracer.Tracer",
