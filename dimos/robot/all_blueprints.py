...
all_modules = {
    ...
    "manipulation-policy-recorder": "dimos.perception.manipulation_policy_recorder.ManipulationPolicyRecorder",
    ...
    "policy-kernel": "dimos.agents.code_policy.policy_kernel.PolicyKernel",
