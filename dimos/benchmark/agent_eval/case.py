...
SourceSpec = FrozenRecordingSource
...
InteractionSpec = FrozenCodePolicyInteraction
...
ValidatorRef = ExactIntegerValidatorRef
...
class PrivateScore(BaseEvalModel):
    ...
    passed: bool
    prediction_status: Literal["parsed", "invalid"]
