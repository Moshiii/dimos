...
@dataclass(frozen=True)
class NumericAnswerContract:
    """A numeric answer with an explicit display unit and scoring tolerance."""
...
AnswerContract = BooleanAnswerContract | ChoiceAnswerContract | NumericAnswerContract
