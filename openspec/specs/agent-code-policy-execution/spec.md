# agent-code-policy-execution Specification

## Purpose

Define trusted attempt-local Python code-policy execution for evaluated agents,
including its model-facing surface, state lifecycle, observations, and evidence.
