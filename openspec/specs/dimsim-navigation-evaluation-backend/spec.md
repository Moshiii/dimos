# dimsim-navigation-evaluation-backend Specification

## Purpose

Define the current-compatible DimSim closed-loop navigation backend, private
rubric, correlated lifecycle, and external-Pi evaluation blueprint.
