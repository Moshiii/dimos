# local-agent-evaluation-runner Specification

## Purpose

Define the trusted local single-attempt Pi runner, its backend boundary,
preparation order, evidence model, outcomes, and attached-service ownership.
