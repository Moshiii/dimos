.. _doc-platforms-humanoid-g1-index--unitree-g1:

==========
Unitree G1
==========

.. _doc-platforms-humanoid-g1-index--requirements:
...
.. _doc-platforms-humanoid-g1-index--1-get-ssh-access:

1. Get SSH Access
-----------------

.. _doc-platforms-humanoid-g1-index--get-ethernet-working:
...
.. _doc-platforms-humanoid-g1-index--use-ethernet-to-get-wifi-working:
...
.. _doc-platforms-humanoid-g1-index--network-interface-names:
...
.. _doc-platforms-humanoid-g1-index--remote-network:

Remote Network
~~~~~~~~~~~~~~

Set up `Tailscale <https://tailscale.com/tailscale-ssh>`__ to avoid
router-specific configuration for wireless control.

.. _2-install-dimos:

.. _doc-platforms-humanoid-g1-index--2-install-dimos:
...
.. _doc-platforms-humanoid-g1-index--notes:
...
.. _3-get-the-g1-in-sport-mode:

.. _doc-platforms-humanoid-g1-index--3-get-the-g1-in-sport-mode:
...
.. _4-run-the-blueprint:

.. _doc-platforms-humanoid-g1-index--4-run-the-blueprint:
...
.. _doc-platforms-humanoid-g1-index--troubleshooting:

Troubleshooting
~~~~~~~~~~~~~~~

.. _doc-platforms-humanoid-g1-index--keyboard-controls-not-working:
...
.. _doc-platforms-humanoid-g1-index--viewer-crashing:
...
.. _doc-platforms-humanoid-g1-index--external-resources:

External Resources
------------------

- `Unitree Developer Docs <https://support.unitree.com/home/en/developer>`__
- `Sport Mode Services <https://support.unitree.com/home/en/developer/sports_services>`__
- `Unitree SDK2 Python <https://github.com/unitreerobotics/unitree_sdk2_python>`__
