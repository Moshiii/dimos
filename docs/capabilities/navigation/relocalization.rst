.. _doc-capabilities-navigation-relocalization--premap-relocalization:
...
.. _doc-capabilities-navigation-relocalization--1-record-a-run:
...
.. _doc-capabilities-navigation-relocalization--2-build-the-premap:
...
.. _3-relocalize-in-replay:

.. _doc-capabilities-navigation-relocalization--3-relocalize-in-replay:
...
.. _doc-capabilities-navigation-relocalization--reading-the-logs:
...
.. _doc-capabilities-navigation-relocalization--rerun-visualization:
...
.. _4-relocalize-on-a-live-robot:

.. _doc-capabilities-navigation-relocalization--4-relocalize-on-a-live-robot:
...
.. _doc-capabilities-navigation-relocalization--how-it-works:
...
.. _doc-capabilities-navigation-relocalization--file-formats:
...
.. _doc-capabilities-navigation-relocalization--troubleshooting:
...
.. _doc-capabilities-navigation-relocalization--related-docs:

Related docs
------------

For hardware setup, simulation, and the full blueprint list, see the :doc:`Go2 platform guide </platforms/quadruped/go2/index>`. The `v0.0.13 release notes <https://github.com/dimensionalOS/dimos/releases/tag/v0.0.13>`__ summarize the PGO, ``dimos map``, and relocalization work this guide builds on.

.. |relocalize on the live go2 and nav_to a point in the premap| image:: https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/navigation/assets/reloc_and_nav_to.webp
.. |unitree-go2-relocalization blueprint module graph| image:: assets/go2_reloc_blueprint.svg
