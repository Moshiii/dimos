.. _doc-capabilities-manipulation-openarm-integration--openarm-integration:

===================
OpenArm Integration
===================

.. _doc-capabilities-manipulation-openarm_integration--openarm-integration:
...
**If you're standing in front of the hardware and just want to run it, skip to** :ref:`Quick start <doc-capabilities-manipulation-openarm_integration--quick-start>`\ **.**

Related:

- Upstream hardware + C++ reference: `enactic/openarm_can <https://github.com/enactic/openarm_can>`__
- How to integrate any new arm: :doc:`/capabilities/manipulation/adding_a_custom_arm`

--------------

.. _doc-capabilities-manipulation-openarm_integration--why-this-integration-is-different:
...
**OpenArm ships no Python SDK.** The only interface is raw CAN frames on the wire, speaking the Damiao MIT-mode protocol. So dimos includes a from-scratch driver that encodes/decodes the protocol directly on a SocketCAN bus. The reference implementation is the Enactic C++ library at `enactic/openarm_can <https://github.com/enactic/openarm_can>`__ — we port the frame layout from there.

.. _doc-capabilities-manipulation-openarm_integration--architecture:
...
Workspace analysis is generic and lives in `dimos/utils/workspace.py <https://github.com/dimensionalOS/dimos/blob/main/dimos/utils/workspace.py>`__ — works for any URDF, not just OpenArm.

--------------

.. _doc-capabilities-manipulation-openarm_integration--quick-start:
...
.. _1-bring-up-the-can-buses:

.. _doc-capabilities-manipulation-openarm_integration--1-bring-up-the-can-buses:
...
.. _2-verify-all-16-motors-are-alive:

.. _doc-capabilities-manipulation-openarm_integration--2-verify-all-16-motors-are-alive:
...
.. _3-first-time-only-put-motors-in-mit-mode:

.. _doc-capabilities-manipulation-openarm_integration--3-first-time-only-put-motors-in-mit-mode:
...
.. _doc-capabilities-manipulation-openarm_integration--4-run-a-blueprint:
...
.. _5-drive-the-arms-from-the-manipulation-client:

.. _doc-capabilities-manipulation-openarm_integration--5-drive-the-arms-from-the-manipulation-client:
...
.. _example-session--simple-joint-moves:

.. _doc-capabilities-manipulation-openarm_integration--example-session-simple-joint-moves:
...
.. _example-session--bimanual:

.. _doc-capabilities-manipulation-openarm_integration--example-session-bimanual:
...
.. _example-session--cartesian-target:

.. _doc-capabilities-manipulation-openarm_integration--example-session-cartesian-target:
...
If you don't know which Cartesian targets are reachable, check first with the workspace tool — see :ref:`Workspace analysis <doc-capabilities-manipulation-openarm_integration--workspace-analysis>` below. ``plan_pose`` will fail with ``NO_SOLUTION`` if the IK can't find a configuration reaching the target.

.. _doc-capabilities-manipulation-openarm_integration--adding-obstacles:
...
.. _doc-capabilities-manipulation-openarm_integration--gain-tuning-mit-kpkd:

Gain tuning (MIT kp/kd)
~~~~~~~~~~~~~~~~~~~~~~~

Defaults live in `adapter.py <https://github.com/dimensionalOS/dimos/blob/main/dimos/hardware/manipulators/openarm/adapter.py>`__. Gains are per-joint because the shoulder motors (DM8006, 40 Nm) tolerate higher kp than the wrist motors (DM4310, 10 Nm):
...
.. _doc-capabilities-manipulation-openarm_integration--physical-joint-limits:
...
.. _doc-capabilities-manipulation-openarm_integration--damiao-protocol-essentials:
...
.. _enable--disable--zero-position:

.. _doc-capabilities-manipulation-openarm_integration--enable-disable-zero-position:
...
.. _doc-capabilities-manipulation-openarm_integration--mit-control-frame-8-bytes:
...
.. _doc-capabilities-manipulation-openarm_integration--state-reply-8-bytes-on-recv_id:
...
.. _doc-capabilities-manipulation-openarm_integration--ctrl_mode-register-write:
...
.. _doc-capabilities-manipulation-openarm_integration--known-gotchas:
...
- **Arms swap sides.** USB enumeration order flipped. Swap ``LEFT_CAN`` / ``RIGHT_CAN`` in `config.py <https://github.com/dimensionalOS/dimos/blob/main/dimos/robot/manipulators/openarm/config.py>`__.

--------------

.. _doc-capabilities-manipulation-openarm_integration--design-decisions:
...
.. _doc-capabilities-manipulation-openarm_integration--workspace-analysis:
...
.. _doc-capabilities-manipulation-openarm_integration--testing:
