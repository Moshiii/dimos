.. _doc-capabilities-manipulation-a750--a-750-robotic-arm:
...
.. _doc-capabilities-manipulation-a750--quick-start:
...
| Module                                                                                            | Role                                                                                                                      |
+===================================================================================================+===========================================================================================================================+
| :class:`KeyboardTeleopModule <dimos.teleop.keyboard.keyboard_teleop_module.KeyboardTeleopModule>` | Publishes routed spatial EEF twist intent from the keyboard UI                                                            |
+---------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------+
| :class:`ControlCoordinator <dimos.control.coordinator.ControlCoordinator>`                        | Runs a 100 Hz coordinator loop and :class:`EEFTwistTask <dimos.control.tasks.eef_twist_task.eef_twist_task.EEFTwistTask>` |
+---------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------+
| :class:`ManipulationModule <dimos.manipulation.manipulation_module.ManipulationModule>`           | Loads the A-750 robot model in Drake and serves Meshcat visualization                                                     |
+---------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------+

Open the Meshcat URL printed in the terminal, usually ``http://localhost:7000``, to view the robot.

.. _doc-capabilities-manipulation-a750--real-hardware:
...
+-------------------------+----------------------------------------------------------------------------------------+
| Base link               | :attr:`base_link <dimos.manipulation.planning.spec.config.RobotModelConfig.base_link>` |
+-------------------------+----------------------------------------------------------------------------------------+
...
.. _doc-capabilities-manipulation-a750--gripper:
...
.. _doc-capabilities-manipulation-a750--hardware-adapter:

Hardware Adapter
----------------

The adapter is registered as ``a750`` in `dimos/hardware/manipulators/a750/adapter.py <https://github.com/dimensionalOS/dimos/blob/main/dimos/hardware/manipulators/a750/adapter.py#L40>`__.
...
.. _doc-capabilities-manipulation-a750--control-path:

Control Path
------------

The ``keyboard-teleop-a750`` blueprint is defined in `dimos/robot/manipulators/a750/blueprints/teleop.py <https://github.com/dimensionalOS/dimos/blob/main/dimos/robot/manipulators/a750/blueprints/teleop.py>`__.
...
.. _doc-capabilities-manipulation-a750--keyboard-controls:
...
.. _doc-capabilities-manipulation-a750--known-limitations:
