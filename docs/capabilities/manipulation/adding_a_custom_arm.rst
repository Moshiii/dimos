.. _doc-capabilities-manipulation-adding-a-custom-arm--how-to-integrate-a-new-manipulator-arm:

======================================
How to Integrate a New Manipulator Arm
======================================

.. _doc-capabilities-manipulation-adding_a_custom_arm--how-to-integrate-a-new-manipulator-arm:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--architecture-overview:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--prerequisites:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--step-1-create-the-adapter:
...
.. _adapterpy--full-skeleton:

.. _doc-capabilities-manipulation-adding_a_custom_arm--adapterpy-full-skeleton:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--key-implementation-notes:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--step-2-create-package-files:

Step 2: Create Package Files
----------------------------

.. _doc-capabilities-manipulation-adding_a_custom_arm--how-discovery-works:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--step-3-create-your-robot-folder-and-blueprints:
...
.. _3a-create-the-robot-directory:

.. _doc-capabilities-manipulation-adding_a_custom_arm--3a-create-the-robot-directory:
...
.. _3b-define-your-blueprints:

.. _doc-capabilities-manipulation-adding_a_custom_arm--3b-define-your-blueprints:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--blueprint-field-reference:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--4a-add-your-urdf:
...
.. _4b-create-a-robot-model-config-helper:

.. _doc-capabilities-manipulation-adding_a_custom_arm--4b-create-a-robot-model-config-helper:
...
.. _4c-create-a-planning-blueprint:

.. _doc-capabilities-manipulation-adding_a_custom_arm--4c-create-a-planning-blueprint:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--key-config-fields:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--step-6-testing:

Step 6: Testing
---------------

.. _doc-capabilities-manipulation-adding_a_custom_arm--verify-adapter-registration:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--unit-test-with-mock:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--integration-test-with-coordinator:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--test-the-real-adapter-standalone:
...
.. _doc-capabilities-manipulation-adding_a_custom_arm--quick-reference-checklist:
