...
The robot registers with the broker. Open `teleop.dimensionalos.com <https://teleop.dimensionalos.com>`__, log in, and your robot appears under **Available Robots**. Click **Connect** and you're driving.
...
.. _doc-capabilities-teleoperation-hosted--get-an-api-key:

Get an API key
--------------

1. Visit `teleop.dimensionalos.com <https://teleop.dimensionalos.com>`__ and sign up.
2. On the dashboard, **API Keys → + New Key**.
3. Copy the key (shown once) and pass it as ``TRANSPORTS__BROKER__API_KEY``.

.. _doc-capabilities-teleoperation-hosted--available-blueprints:
...
.. _doc-capabilities-teleoperation-hosted--operating-the-robot:
...
.. _3-navigate-with-the-minimap:

.. _doc-capabilities-teleoperation-hosted--3-navigate-with-the-minimap:
...
.. _4-postures-and-commands:

.. _doc-capabilities-teleoperation-hosted--4-postures-and-commands:
...
.. _doc-capabilities-teleoperation-hosted--5-e-stop:
...
.. _doc-capabilities-teleoperation-hosted--operator-inputs:
...
.. _doc-capabilities-teleoperation-hosted--live-metrics-hud:
...
.. _doc-capabilities-teleoperation-hosted--configuration:
...
.. _doc-capabilities-teleoperation-hosted--how-it-connects:
...
For the broker session, datachannels, and reconnect behavior, see `dimos/teleop/hosted/README.md <https://github.com/dimensionalOS/dimos/blob/main/dimos/teleop/hosted/README.md>`__.

.. |Round-trip command latency to robots hosted in San Francisco: ~15 ms from San Francisco, ~114 ms from Bangalore, ~134 ms from Buenos Aires, ~160 ms from Shanghai — every route under the ~200 ms delay of a typical video call| image:: https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/teleoperation/assets/latency_four_continents.png
