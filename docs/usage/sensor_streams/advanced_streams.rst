.. _doc-usage-sensor-streams-advanced-streams--advanced-stream-handling:

========================
Advanced Stream Handling
========================

.. _doc-usage-sensor_streams-advanced_streams--advanced-stream-handling:

========================
Advanced Stream Handling
========================

**Prerequisite:** Read :doc:`ReactiveX Fundamentals </usage/sensor_streams/reactivex>` first for Observable basics.

.. _doc-usage-sensor_streams-advanced_streams--backpressure-and-parallel-subscribers-to-hardware:
...
.. _doc-usage-sensor_streams-advanced_streams--how-it-works:
...
.. _doc-usage-sensor_streams-advanced_streams--usage-in-modules:
...
.. _doc-usage-sensor_streams-advanced_streams--getting-values-synchronously:
...
If you are doing this periodically as a part of a processing loop, it is very likely that your code will be much cleaner and safer using actual reactivex pipeline. So bias towards checking our :doc:`reactivex quick guide </usage/sensor_streams/reactivex>` and `official docs <https://rxpy.readthedocs.io/>`__
...
.. _doc-usage-sensor_streams-advanced_streams--getter_hot-background-subscription-instant-reads:
...
.. _doc-usage-sensor_streams-advanced_streams--getter_cold-fresh-subscription-each-call:
...
.. |output| image:: assets/backpressure.svg
.. |image1| image:: assets/backpressure_solution.svg
.. |image2| image:: assets/getter_hot_cold.svg
