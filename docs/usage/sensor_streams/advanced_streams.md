...
If you are doing this periodically as a part of a processing loop, it is very likely that your code will be much cleaner and safer using actual reactivex pipeline. So bias towards checking our {doc}`reactivex quick guide </usage/sensor_streams/reactivex>` and [official docs](https://rxpy.readthedocs.io/)
