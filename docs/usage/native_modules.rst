.. _doc-usage-native-modules--native-modules:

==============
Native Modules
==============

.. _doc-usage-native_modules--native-modules:
...
.. _doc-usage-native_modules--defining-a-native-module:
...
.. _doc-usage-native_modules--config:
...
.. _doc-usage-native_modules--excluding-fields:
...
.. _doc-usage-native_modules--using-with-blueprints:
...
.. _doc-usage-native_modules--logging:
...
.. _doc-usage-native_modules--json-log-format:
...
.. _doc-usage-native_modules--writing-the-c-side:

Writing the C++ side
--------------------

A header-only helper is provided at `dimos/hardware/sensors/lidar/common/dimos_native_module.hpp <https://github.com/dimensionalOS/dimos/blob/main/dimos/hardware/sensors/lidar/common/dimos_native_module.hpp>`__:
...
.. _doc-usage-native_modules--examples:

Examples
--------

For language interop examples (subscribing to DimOS topics from C++, TypeScript, Lua), see `/examples/language-interop/ <https://github.com/dimensionalOS/dimos/blob/main/examples/language-interop/README.md>`__.

.. _doc-usage-native_modules--livox-mid-360-module:

Livox Mid-360 Module
~~~~~~~~~~~~~~~~~~~~

The Livox Mid-360 LiDAR driver is a complete example at `dimos/hardware/sensors/lidar/livox/module.py <https://github.com/dimensionalOS/dimos/blob/main/dimos/hardware/sensors/lidar/livox/module.py>`__:
...
.. _doc-usage-native_modules--auto-building:
...
.. _doc-usage-native_modules--faster-builds-via-the-cachix-substituter:
