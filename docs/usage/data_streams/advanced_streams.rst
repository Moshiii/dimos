.. _doc-usage-data-streams-advanced-streams--advanced-stream-handling:

========================
Advanced Stream Handling
========================

.. _doc-usage-data_streams-advanced_streams--advanced-stream-handling:
...
.. _doc-usage-data_streams-advanced_streams--backpressure-and-parallel-subscribers-to-hardware:
...
.. _doc-usage-data_streams-advanced_streams--how-it-works:
...
.. _doc-usage-data_streams-advanced_streams--usage-in-modules:
...
.. _doc-usage-data_streams-advanced_streams--getting-values-synchronously:
...
If you are doing this periodically as a part of a processing loop, it is very likely that your code will be much cleaner and safer using actual reactivex pipeline. So bias towards checking our :doc:`reactivex quick guide </usage/data_streams/reactivex>` and `official docs <https://rxpy.readthedocs.io/>`__
