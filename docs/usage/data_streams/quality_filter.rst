.. _doc-usage-data-streams-quality-filter--quality-based-stream-filtering:

==============================
Quality-Based Stream Filtering
==============================

.. _doc-usage-data_streams-quality_filter--quality-based-stream-filtering:
...
.. _doc-usage-data_streams-quality_filter--the-problem:
...
.. _doc-usage-data_streams-quality_filter--the-solution-quality_barrier:
...
.. _doc-usage-data_streams-quality_filter--image-sharpness-filtering:
...
.. _doc-usage-data_streams-quality_filter--usage-in-camera-module:
...
.. _doc-usage-data_streams-quality_filter--how-sharpness-is-calculated:
...
from `Image.py <https://github.com/dimensionalOS/dimos/blob/main/dimos/msgs/sensor_msgs/Image.py>`__
...
.. _doc-usage-data_streams-quality_filter--custom-quality-functions:
...
.. _doc-usage-data_streams-quality_filter--api-reference:

API Reference
-------------

.. _doc-usage-data_streams-quality_filter--quality_barrierquality_func-target_frequency:
...
.. _doc-usage-data_streams-quality_filter--sharpness_barriertarget_frequency:
...
.. |output| image:: https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/data_streams/assets/frame_mosaic.jpg
.. |image1| image:: assets/sharpness_graph.svg
.. |image2| image:: https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/data_streams/assets/frame_mosaic2.jpg
.. |image3| image:: assets/sharpness_graph2.svg
