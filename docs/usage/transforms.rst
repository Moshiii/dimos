.. _doc-usage-transforms--transforms:

==========
Transforms
==========

.. _doc-usage-transforms--the-problem-everything-measures-from-its-own-perspective:
...
.. _doc-usage-transforms--whats-a-coordinate-frame:
...
.. _doc-usage-transforms--the-transform-class:
...
.. _doc-usage-transforms--transform-operations:
...
.. _doc-usage-transforms--converting-to-matrix-form:
...
.. _doc-usage-transforms--frame-ids-in-modules:
...
.. _doc-usage-transforms--the-tf-service:
...
The TF service is implemented in `protocol/tf/tf.py <https://github.com/dimensionalOS/dimos/blob/main/dimos/protocol/tf/tf.py>`__ and is lazily initialized on first access.

.. _doc-usage-transforms--multi-module-transform-example:
...
.. _doc-usage-transforms--internals:

Internals
---------

.. _doc-usage-transforms--transform-buffer:
...
.. _doc-usage-transforms--further-reading:
...
- `Coordinate Transforms (YouTube) <https://www.youtube.com/watch?v=NGPn9nvLPmg>`__

For the mathematical foundations, the ROS documentation provides detailed background:

- `ROS tf2 Concepts <http://wiki.ros.org/tf2>`__
- `ROS REP 103 - Standard Units and Coordinate Conventions <https://www.ros.org/reps/rep-0103.html>`__
- `ROS REP 105 - Coordinate Frames for Mobile Platforms <https://www.ros.org/reps/rep-0105.html>`__
...
.. |output| image:: assets/transforms_tree.svg
.. |transforms| image:: https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/assets/transforms.png
.. |image1| image:: assets/transforms_modules.svg
