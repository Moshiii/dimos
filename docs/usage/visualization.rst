.. _doc-usage-visualization--viewer-backends:
...
.. _doc-usage-visualization--quick-start:
...
.. _doc-usage-visualization--viewer-modes-explained:

Viewer Modes Explained
----------------------

.. _rerun-native-rerun---rerun-open-native--default:

.. _doc-usage-visualization--rerun-native-rerun-rerun-open-native-default:
...
- `dimos-viewer <https://github.com/dimensionalOS/dimos-viewer>`__, a custom Dimensional fork of Rerun with built-in keyboard teleop and click-to-navigate
...
.. _doc-usage-visualization--rerun-web-rerun-rerun-open-web:
...
.. _doc-usage-visualization--rendering-with-custom-blueprints:
...
.. _doc-usage-visualization--symptom-slow-map-updates:
...
.. _doc-usage-visualization--increase-voxel-size:

Increase Voxel Size
~~~~~~~~~~~~~~~~~~~

Edit `dimos/robot/unitree/go2/blueprints/smart/unitree_go2.py <https://github.com/dimensionalOS/dimos/blob/main/dimos/robot/unitree/go2/blueprints/smart/unitree_go2.py>`__:
...
.. _doc-usage-visualization--direct-visualization-from-a-module:
