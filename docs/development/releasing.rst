.. _doc-development-releasing--releasing:
...
.. _1-preparing-for-a-release:

.. _doc-development-releasing--1-preparing-for-a-release:
...
.. _2-creating-the-release:

.. _doc-development-releasing--2-creating-the-release:
...
2. `Run <https://docs.github.com/en/actions/how-tos/manage-workflow-runs/manually-run-a-workflow#running-a-workflow>`__ the ``release`` workflow on the ``release/X.Y.Z`` branch.
...
.. _doc-development-releasing--3-cleanup:
...
.. _doc-development-releasing--patch-fix-on-a-released-version:
...
.. _doc-development-releasing--verifying-a-release-tag:
...
.. _doc-development-releasing--rotating-the-app-private-key:
...
.. _doc-development-releasing--rotating-the-gpg-signing-key:
