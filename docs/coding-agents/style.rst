.. _doc-coding-agents-style--code-style-guidelines:
...
.. _doc-coding-agents-style--no-comment-banners:
...
.. _no-__init__py-re-exports:

.. _doc-coding-agents-style--no-__init__py-re-exports:
